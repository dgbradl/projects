Generate one tavern visitor as JSON.
...
- name: the visitor's name — a given name and a plain surname drawn from an
  ordinary word: a trade, a plant, an animal, a place feature. Never a
  welded heroic compound
